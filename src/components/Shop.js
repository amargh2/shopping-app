...
const Shop = (props) => {
  ...
  <div>
    ...
    <div className='row-start-3 row-end-7 col-span-1 border-4 border-cyan-300 shadow-lg rounded-md flex sm:flex justify-center'>
      <SideBar 
      sortItemsByPrice = {props.sort}/>
    </div>
    <div className='row-start-3 gap-4 col-start-4 lg:col-span-6 lg:row-span-7 md:col-span-2'>
      <ProductDisplay 

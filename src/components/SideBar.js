  ...
  return (
    <div className='py-2'>
      ...
      <div className='flex flex-col gap-2 align-items-center py-4 px-2'>
        <button onClick={()=>props.sortItemsByPrice('alphabetical')} className='px-5 text-white shadow-lg py-2 hover:ring-2 hover:ring-yellow-400 rounded-lg bg-cyan-400'>Alphabetical</button>
